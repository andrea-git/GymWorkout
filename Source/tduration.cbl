      *{TOTEM}PRG-COMMENT
      * tduration.Cbl
      * tduration.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tduration, INIT:tduration, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 LOGO_PICCOLO-BMP PIC  S9(9)
                  USAGE IS COMP-4
                  VALUE IS 0.
       77 STATUS-macroduration         PIC  X(2).
           88 Valid-STATUS-macroduration VALUE IS "00" THRU "09". 
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-duration-KEY1-ORDER  PIC X VALUE "A".
       ...
       01 old-dur-rec.
           ...
           05 old-dur-data.
               ...
               10 old-dur-filler-n3    PIC  9(18).
               10 old-dur-filler-n4    PIC  9(18).
      *{TOTEM}END
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tduration, INIT:tduration, BeforeDeclarative>
       coddur-ERR SECTION.
           use after error procedure on duration.
           evaluate status-duration
           when "35"
                display message "File [duration] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
      ...
      * <TOTEM:EPT. INIT:tduration, INIT:tduration, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-duration.
      * <TOTEM:EPT. INIT:tduration, FD:duration, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O duration
           IF STATUS-duration = "35"
              OPEN OUTPUT duration
                IF Valid-STATUS-duration
                   CLOSE duration
                   OPEN I-O duration
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:tduration, FD:duration, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-duration.
      * <TOTEM:EPT. INIT:tduration, FD:duration, BeforeClose>
      * <TOTEM:END>
           CLOSE duration
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-duration-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-duration-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE dur-rec OF duration TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     dur-rec OF duration
           PERFORM DataSet1-duration-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-duration-INITSTART
           PERFORM DataSet1-duration-START
           IF NOT Valid-STATUS-duration
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-duration-Read-Next
           IF NOT Valid-STATUS-duration
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-duration-START-LESS
           IF NOT Valid-STATUS-duration
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-duration-Read-Prev
           IF NOT Valid-STATUS-duration
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-duration-START-GREATER
           IF NOT Valid-STATUS-duration
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-duration-INITEND
           PERFORM DataSet1-duration-START-NOTGREATER
           IF NOT Valid-STATUS-duration
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-duration-Rec-Rewrite
           IF Valid-STATUS-duration
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-duration-Rec-Delete
           IF Valid-STATUS-duration
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-duration
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-duration-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE dur-rec OF duration TO 
              TMP-Form1-duration-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-duration-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-duration-RESTOREBUF TO
              dur-rec OF duration
           PERFORM DataSet1-duration-START
           IF Valid-STATUS-duration
              PERFORM DataSet1-duration-Read-Next
           ELSE
              PERFORM DataSet1-duration-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-duration OR
              (Valid-STATUS-duration AND
                 dur-rec OF duration = 
                   TMP-Form1-duration-RESTOREBUF)
              PERFORM DataSet1-duration-Read-Next
           END-PERFORM
      ...
      *--->fine.                 
           ...
           if scelta = mb-yes
              ...
              delete duration record invalid continue end-delete
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close duration
                 open i-o duration allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-dur-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-dur-code
              move old-dur-code           to dur-code
              read duration                 no lock
              move dur-rec                to old-dur-rec
           else
              initialize old-dur-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      * <TOTEM:PARA. form1-gd-1-Ev-Msg-Begin-Entry>
           ...
           if colonna = 1
              if dur-code not = zero and dur-code not = spaces
                 set event-action to event-action-fail
              end-if
           else 
              if mod = 0
