      *{TOTEM}PRG-COMMENT
      * tgroups.Cbl
      * tgroups.Cbl is generated by TOTEM
      ...
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tgroups, INIT:tgroups, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      ***********************************************************
       ...
       77 TMP-Form1-groups-RESTOREBUF  PIC X(1182).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-groups-KEY1-ORDER  PIC X VALUE "A".
          88 DataSet1-groups-KEY1-Asc  VALUE "A".
          88 DataSet1-groups-KEY1-Desc VALUE "D".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tgroups, INIT:tgroups, BeforeDeclarative>
       codgrp-ERR SECTION.
           use after error procedure on groups.
           evaluate status-groups
           when "35"
                display message "File [groups] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
      ...
      * <TOTEM:EPT. INIT:tgroups, INIT:tgroups, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-groups.
      * <TOTEM:EPT. INIT:tgroups, FD:groups, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O groups
           IF STATUS-groups = "35"
              OPEN OUTPUT groups
                IF Valid-STATUS-groups
                   CLOSE groups
                   OPEN I-O groups
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:tgroups, FD:groups, AfterOpen>
      * <TOTEM:END>
           .

       OPEN-macrogroups.
      * <TOTEM:EPT. INIT:tgroups, FD:macrogroups, BeforeOpen>
      * <TOTEM:END>
           ...
           IF NOT Valid-STATUS-macrogroups
              ...
              GO TO EXIT-STOP-ROUTINE
           END-IF
      * <TOTEM:EPT. INIT:tgroups, FD:macrogroups, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-groups.
      * <TOTEM:EPT. INIT:tgroups, FD:groups, BeforeClose>
      * <TOTEM:END>
           CLOSE groups
           .

       CLOSE-macrogroups.
      * <TOTEM:EPT. INIT:tgroups, FD:macrogroups, BeforeClose>
      * <TOTEM:END>
           CLOSE macrogroups
           .
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-groups-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-groups-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE grp-rec OF groups TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     grp-rec OF groups
           PERFORM DataSet1-groups-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-groups-INITSTART
           PERFORM DataSet1-groups-START
           IF NOT Valid-STATUS-groups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-groups-Read-Next
           IF NOT Valid-STATUS-groups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-groups-START-LESS
           IF NOT Valid-STATUS-groups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-groups-Read-Prev
           IF NOT Valid-STATUS-groups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-groups-START-GREATER
           IF NOT Valid-STATUS-groups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-groups-INITEND
           PERFORM DataSet1-groups-START-NOTGREATER
           IF NOT Valid-STATUS-groups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-groups-Rec-Rewrite
           IF Valid-STATUS-groups
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-groups-Rec-Delete
           IF Valid-STATUS-groups
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-groups
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-groups-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE grp-rec OF groups TO 
              TMP-Form1-groups-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-groups-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-groups-RESTOREBUF TO
              grp-rec OF groups
           PERFORM DataSet1-groups-START
           IF Valid-STATUS-groups
              PERFORM DataSet1-groups-Read-Next
           ELSE
              PERFORM DataSet1-groups-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-groups OR
              (Valid-STATUS-groups AND
                 grp-rec OF groups = 
                   TMP-Form1-groups-RESTOREBUF)
              PERFORM DataSet1-groups-Read-Next
           END-PERFORM
      ...
      *--->fine.                 
           ...
           if scelta = mb-yes
              ...
              delete groups record invalid continue end-delete
      ...
      * <TOTEM:PARA. CERCA>
           evaluate colonna
           when 3
                inquire form1-gd-1(riga, colonna), cell-data in mcg-code
                move "macrogroups"  to Como-File
                call   "zoom-gt" using como-file, mcg-rec
                                giving stato-zoom
                cancel "zoom-gt"
                if stato-zoom = 0
                   move mcg-code to col-macro
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           when 3
                ...
                read macrogroups no lock
                     ...
                     set errori to true
                     move 3 to colonna
                     display message "Macrogruppo non valido"
                             title = tit-err
                             icon mb-warning-icon
                end-read
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close groups
                 open i-o groups allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-grp-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-grp-code
              move old-grp-code           to grp-code
              read groups                 no lock
              move grp-rec                to old-grp-rec
           else
              initialize old-grp-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      * <TOTEM:PARA. form1-gd-1-Ev-Msg-Begin-Entry>
           ...
           if colonna = 1
              if grp-code not = zero and grp-code not = spaces
                 set event-action to event-action-fail
              end-if
           else 
              if mod = 0
