      *{TOTEM}PRG-COMMENT
      * tintexe.Cbl
      * tintexe.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       PROGRAM-ID.          tintexe.
       AUTHOR.              andre.
       DATE-WRITTEN.        martedì 19 settembre 2023 18:41:37.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tintexe, INIT:tintexe, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 Form1-Tb-1-Handle
                  USAGE IS HANDLE OF WINDOW.
       78 titolo VALUE IS "Tabella intensità". 
       77 E-ESCI           PIC  9
                  VALUE IS 1.
       77 E-NUOVO          PIC  9
                  VALUE IS 0.
      ...
      * FILE'S LOCK MODE FLAG
       ...
       01 old-int-rec.
           05 old-int-key.
               10 old-int-code         PIC  99.
           05 old-int-data.
               10 old-int-desc         PIC  x(100).
               10 old-int-rest         PIC  9(3).
               10 old-int-series       PIC  99.
               10 old-int-time         PIC  9(3).
               10 old-int-range.
                   15 old-int-range-from   PIC  99.
                   15 old-int-range-to     PIC  99.
               10 old-int-effort       PIC  99.
               10 old-int-restpause    PIC  9.
               10 old-int-filler       PIC  x(999).
      ...
      * GRID
       05
           ...
           ADJUSTABLE-COLUMNS,
           BOXED,
           DATA-COLUMNS (1, 3, 53, 56, 58, 61, 63, 65, 67),
           ALIGNMENT ("R", "U", "R", "R", "R", "R", "R", "R", "C"),
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tintexe, INIT:tintexe, BeforeDeclarative>
       INTEXE-ERR SECTION.
      ...
      * <TOTEM:EPT. INIT:tintexe, INIT:tintexe, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-intexe.
      * <TOTEM:EPT. INIT:tintexe, FD:intexe, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O intexe
           IF STATUS-intexe = "35"
              OPEN OUTPUT intexe
           ...
           END-IF
      * <TOTEM:EPT. INIT:tintexe, FD:intexe, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-intexe.
      * <TOTEM:EPT. INIT:tintexe, FD:intexe, BeforeClose>
      * <TOTEM:END>
           CLOSE intexe
           .
      ...
      * <TOTEM:PARA. form1-gd-1-Ev-Msg-Begin-Entry>
           ...
           if colonna = 1
              if int-code not = zero and int-code not = spaces
                 set event-action to event-action-fail
              end-if
           else 
              if mod = 0
