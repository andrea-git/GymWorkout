      *{TOTEM}PRG-COMMENT
      * tmgroups.Cbl
      * tmgroups.Cbl is generated by TOTEM
      ...
      *{TOTEM}PRGID
       PROGRAM-ID.          tmgroups.
       AUTHOR.              andre.
       DATE-WRITTEN.        domenica 24 settembre 2023 21:54:51.
       REMARKS.
      *{TOTEM}END
       ...
       SPECIAL-NAMES.
      *{TOTEM}SPECIAL-NAME
      * <TOTEM:EPT. INIT:tmgroups, INIT:tmgroups, SpecialName>
      * <TOTEM:END>
      *{TOTEM}END
      *{TOTEM}ACTIVEX-DEF
      *{TOTEM}END
      ...
      * Properties & User defined Working Stoarge
       ...
       77 LOGO_PICCOLO-BMP PIC  S9(9)
                  USAGE IS COMP-4
                  VALUE IS 0.
       77 STATUS-macromacrogroups      PIC  X(2).
           88 Valid-STATUS-macromacrogroups VALUE IS "00" THRU "09". 
      ...
      ***********************************************************
       ...
       77 TMP-Form1-macrogroups-RESTOREBUF  PIC X(1177).
       77 TMP-Form1-KEYIS  PIC 9(3) VALUE 1.
       77 Form1-MULKEY-TMPBUF   PIC X(1177).
      ...
      * FILE'S LOCK MODE FLAG
       ...
       77 DataSet1-macrogroups-KEY1-ORDER  PIC X VALUE "A".
      ...
      *{TOTEM}DECLARATIVE
       DECLARATIVES.
      * <TOTEM:EPT. INIT:tmgroups, INIT:tmgroups, BeforeDeclarative>
       codmcg-ERR SECTION.
           use after error procedure on macrogroups.
           evaluate status-macrogroups
           when "35"
                display message "File [macrogroups] not found!"
                           title titolo
                            icon 3
                set errori to true
           when "39"
      ...
      * <TOTEM:EPT. INIT:tmgroups, INIT:tmgroups, BeforeDestroyResource>
      * <TOTEM:END>
      ...
      *    After Open
       ...
       OPEN-macrogroups.
      * <TOTEM:EPT. INIT:tmgroups, FD:macrogroups, BeforeOpen>
      * <TOTEM:END>
           OPEN  I-O macrogroups
           IF STATUS-macrogroups = "35"
              OPEN OUTPUT macrogroups
                IF Valid-STATUS-macrogroups
                   CLOSE macrogroups
                   OPEN I-O macrogroups
                END-IF
           END-IF
           ...
           END-IF
      * <TOTEM:EPT. INIT:tmgroups, FD:macrogroups, AfterOpen>
      * <TOTEM:END>
           .
      ...
      *    After Close
       ...
       CLOSE-macrogroups.
      * <TOTEM:EPT. INIT:tmgroups, FD:macrogroups, BeforeClose>
      * <TOTEM:END>
           CLOSE macrogroups
           .
       ...
       DataSet1-macrogroups-INITSTART.
           ...
           WHEN 1
              IF DataSet1-macrogroups-KEY1-Asc
       ...
       DataSet1-Change-CurrentKey-Asc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "A" TO DataSet1-macrogroups-KEY1-ORDER
           END-EVALUATE
           .
       ...
       DataSet1-Change-CurrentKey-Desc.
           EVALUATE DataSet1-KEYIS
           WHEN 1
              MOVE "D" TO DataSet1-macrogroups-KEY1-ORDER
           END-EVALUATE
           .
      ...
      * <TOTEM:END>
           REWRITE mcg-rec OF macrogroups.
           MOVE STATUS-macrogroups TO TOTEM-ERR-STAT
           MOVE "macrogroups" TO TOTEM-ERR-FILE
      ...
      * GRID
       ...
       Form1-DataSet1-Update-Key.
           MOVE mcg-rec OF macrogroups TO
                     Form1-MULKEY-TMPBUF
           PERFORM Form1-CLEAR
           PERFORM Form1-INIT-DATA
           MOVE Form1-MULKEY-TMPBUF TO
                     mcg-rec OF macrogroups
           PERFORM DataSet1-macrogroups-Read
       ...
       Form1-First.
           ...
           PERFORM DataSet1-macrogroups-INITSTART
           PERFORM DataSet1-macrogroups-START
           IF NOT Valid-STATUS-macrogroups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-macrogroups-Read-Next
           IF NOT Valid-STATUS-macrogroups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Previous.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-macrogroups-START-LESS
           IF NOT Valid-STATUS-macrogroups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
           PERFORM DataSet1-macrogroups-Read-Prev
           IF NOT Valid-STATUS-macrogroups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Next.
              PERFORM Form1-Buf-To-Fld
              PERFORM DataSet1-macrogroups-START-GREATER
           IF NOT Valid-STATUS-macrogroups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Last.
           ...
           PERFORM DataSet1-macrogroups-INITEND
           PERFORM DataSet1-macrogroups-START-NOTGREATER
           IF NOT Valid-STATUS-macrogroups
              PERFORM Form1-Extended-File-Status
              EXIT PARAGRAPH
           END-IF
      ...
      * <TOTEM:END>
      * write
           PERFORM DataSet1-macrogroups-Rec-Rewrite
           IF Valid-STATUS-macrogroups
      ...
      * delete
           PERFORM Form1-Buf-To-Fld
           PERFORM DataSet1-macrogroups-Rec-Delete
           IF Valid-STATUS-macrogroups
              PERFORM Form1-CLEAR
              PERFORM Form1-DUMMY-DELETE-INIT
              MOVE "303" TO TOTEM-MSG-ID
              MOVE "00" to STATUS-macrogroups
           END-IF
      ...
      * <TOTEM:END>
       ...
       Form1-Save-Status.
           MOVE DataSet1-macrogroups-KEY1-ORDER TO TMP-Form1-KEY1-ORDER
           MOVE DataSet1-KEYIS TO TMP-Form1-KEYIS
           MOVE mcg-rec OF macrogroups TO 
              TMP-Form1-macrogroups-RESTOREBUF
           .             

       Form1-Restore-Status.
           MOVE TMP-Form1-KEY1-ORDER TO DataSet1-macrogroups-KEY1-ORDER
           MOVE TMP-Form1-KEYIS TO DataSet1-KEYIS
           MOVE TMP-Form1-macrogroups-RESTOREBUF TO
              mcg-rec OF macrogroups
           PERFORM DataSet1-macrogroups-START
           IF Valid-STATUS-macrogroups
              PERFORM DataSet1-macrogroups-Read-Next
           ELSE
              PERFORM DataSet1-macrogroups-INITREC
           END-IF
           PERFORM UNTIL NOT Valid-STATUS-macrogroups OR
              (Valid-STATUS-macrogroups AND
                 mcg-rec OF macrogroups = 
                   TMP-Form1-macrogroups-RESTOREBUF)
              PERFORM DataSet1-macrogroups-Read-Next
           END-PERFORM
      ...
      *--->fine.                 
           ...
           if scelta = mb-yes
              ...
              delete macrogroups record invalid continue end-delete
      ...
      * <TOTEM:PARA. CONTROLLO>
           ...
           when 3
                if mcg-isPrimary not = 1 and not = 0
                   set errori to true
                   move 2 to colonna
      ...
      * <TOTEM:PARA. LOAD-RECORD>
           ...
           start macrogroups key is >= mcg-key
                  invalid continue
              not invalid
                  perform varying riga from 2 by 1
                     ...
                     read macrogroups next
                      ...
                      not at end
                          ...
                          move mcg-isPrimary to col-prim
      ...
      *--->modifica (isacco)
           if nuovo 
              ...
              if mod = 1
                 close macrogroups
                 open i-o macrogroups allowing readers
              else
                 set tutto-ok to true
                 if NoSalvato
                    move 1 to mod
      ...
      * <TOTEM:PARA. NUOVO>
           ...
           if tutto-ok
              ...
              initialize old-mcg-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
      ...
      * <TOTEM:PARA. VALORE-RIGA>
           ...
           inquire form1-gd-1(riga, 3), cell-data mcg-isPrimary    
           .
      * <TOTEM:END>
      ...
      * <TOTEM:PARA. VALORE-OLD-RIGA>
           if vecchio
              inquire form1-gd-1(riga, 1) cell-data old-mcg-code
              move old-mcg-code           to mcg-code
              read macrogroups                 no lock
              move mcg-rec                to old-mcg-rec
           else
              initialize old-mcg-rec replacing numeric data by zeroes
                                          alphanumeric data by spaces
           end-if 
      ...
      * <TOTEM:PARA. form1-gd-1-Ev-Msg-Begin-Entry>
           ...
           if colonna = 1
              if mcg-code not = zero and mcg-code not = spaces
                 set event-action to event-action-fail
              end-if
           else 
              if mod = 0
